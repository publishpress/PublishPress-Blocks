(function ( wpI18n, wpBlocks, wpElement, wpBlockEditor, wpComponents, wpData, lodash, wpHtmlEntities, wpDate ) {
    ...
    const FRONTPAGE_LAYOUTS = [
        { layout: '1-3', icon: '1-3', title: __( 'Four: 100 - 1/3 - 1/3 - 1/3', 'advanced-gutenberg' ) },
        { layout: '1-4', icon: '1-4', title: __( 'Five: 100 - 1/4 - 1/4 - 1/4 - 1/4', 'advanced-gutenberg' ) },
        { layout: '1-5', icon: '1-5', title: __( 'Six: 100 - 1/5 - 1/5 - 1/5 - 1/5 - 1/5', 'advanced-gutenberg' ) },
    ];
    ...
    class RecentPostsEdit extends Component {
        ...
        render() {
            ...
            const inspectorControls = (
                <InspectorControls>
                    {postView === 'frontpage' &&
                    <PanelBody title={ __( 'Frontpage Layout', 'advanced-gutenberg' ) }>
