...
(function ( wpI18n, wpBlocks, wpElement, wpBlockEditor, wpComponents, wpData, lodash, wpHtmlEntities, wpDate ) {
    ...
    const NEWSPAPER_LAYOUTS = [
        ...
        { layout: 'np-1-1-a', icon: 'np-1-1', title: __( 'One leading post in the right, 1 posts in the left', 'advanced-gutenberg' ) },
        { layout: 'np-1-2-a', icon: 'np-1-2', title: __( 'One leading post in the right, 2 posts in the left', 'advanced-gutenberg' ) },
        { layout: 'np-1-3-a', icon: 'np-1-3', title: __( 'One leading post in the right, 3 posts in the left', 'advanced-gutenberg' ) },
        { layout: 'np-1-4-a', icon: 'np-1-4', title: __( 'One leading post in the right, 4 posts in the left', 'advanced-gutenberg' ) },
        { layout: 'np-1-5-a', icon: 'np-1-5', title: __( 'One leading post in the right, 5 posts in the left', 'advanced-gutenberg' ) },
