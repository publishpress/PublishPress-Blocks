...
(function ( wpI18n, wpBlocks, wpElement, wpBlockEditor, wpComponents, wpData, lodash, wpHtmlEntities, wpDate ) {
    ...
    class RecentPostsEdit extends Component {
        ...
        render() {
            ...
            const postSuggestions = this.state.postSuggestions;
    ...
    registerBlockType( 'advgb/recent-posts', {
        ...
        edit: withSelect( ( select, props ) => {
            ...
            const { categories, tagIds, tags, category, order, orderBy, numberOfPosts, myToken, postType, excludeCurrentPost, excludeIds, includeIds } = props.attributes;
