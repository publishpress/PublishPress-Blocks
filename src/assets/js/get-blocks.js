window.onload = function () {
    if (typeof wp.blocks !== 'undefined') {
        ...
        listBlocks.forEach(function (block) {
            ...
            var blockHTML = '';
            blockHTML += '<li class="block-item block-access-item ju-settings-option block-item-editable" data-type="'+ block.name +'">';
            ...
            // from main.js
            checked = advgbGetCUserRoleFeature( 'access', block );
