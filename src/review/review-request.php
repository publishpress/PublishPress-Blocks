    			...
    			$triggers = apply_filters( 'ppb_reviews_triggers', array(
    				'time_installed' => array(
    					'triggers' => array(
    						...
    						'one_month'    => array(
    							'message'    => sprintf( $time_message, __( '1 month', 'advanced-gutenberg' ) ),
    							'conditions' => array(
    						...
    						'three_months' => array(
    							'message'    => sprintf( $time_message, __( '3 months', 'advanced-gutenberg' ) ),
    							'conditions' => array(
    	...
    	public static function admin_notices() {
    		...
    		<script type="text/javascript">
    			(function ($) {
    				...
    				$(document)
    					.on('click', '.ppb-notice .ppb-dismiss', function (event) {
    						var $this = $(this),
    							reason = $this.data('reason'),
    							notice = $this.parents('.ppb-notice');
    					...
    					.ready(function () {
    						setTimeout(function () {
    							$('.ppb-notice button.notice-dismiss').click(function (event) {
    								dismiss('maybe_later');
    							});
    						}, 1000);
    					});
    		...
    		<div class="notice notice-success is-dismissible ppb-notice">
    			...
    			<p>
                    <a class="button button-primary ppb-dismiss" target="_blank" href="https://wordpress.org/support/plugin/advanced-gutenberg/reviews/?filter=5#rate-response" data-reason="am_now">
                        ...
                        <?php _e( 'I already did', 'advanced-gutenberg' ); ?>
                    </a>
    			</p>
