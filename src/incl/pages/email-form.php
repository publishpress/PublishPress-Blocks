...
<div id="advgb-settings-container">
    ...
    <h1 class="advgb-settings-header">
        <?php esc_html_e( 'Email and Form settings', 'advanced-gutenberg' ) ?>
    </h1>
    ...
    <div id="captcha-tab" class="clearfix">
        <form method="POST">
                    ...
                    <div class="settings-option-wrapper clearfix">
                        ...
                        >
                            ...
                            (<a target="_blank" href="https://developers.google.com/recaptcha/docs/language">
                                <?php esc_html_e( 'List', 'advanced-gutenberg' ) ?>
                            </a>)
                        </label>
                        <div>
                            <input type="text"
    ...
    <div id="export-block-data" class="clearfix">
