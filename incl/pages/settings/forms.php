...
$contact_form_sender_email   = $this->getOptionSetting(
    'advgb_email_sender',
...
<form method="post">
    <?php
    wp_nonce_field('advgb_email_config_nonce', 'advgb_email_config_nonce_field') ?>
    <p>
        <?php
        _e(
    ...
    <table class="form-table">
        <tr>
            <th scope="row">
                <?php
                _e('Sender name', 'advanced-gutenberg') ?>
            </th>
            <td>
                <label>
                    <input type="text"
        ...
        <tr>
            <th scope="row">
                <?php
                _e('Sender email', 'advanced-gutenberg') ?>
            </th>
            <td>
                <label>
                    <input type="email"
                           ...
                           class="regular-text"
                           value="<?php
                            echo esc_attr($contact_form_sender_email) ?>"
                    />
                </label>
            </td>
        </tr>
        <tr>
            <th scope="row">
                <?php
                _e('Email title', 'advanced-gutenberg') ?>
            </th>
            <td>
                <label>
                    <input type="text"
        ...
        <tr>
            <th scope="row">
                <?php
                _e('Email receiver', 'advanced-gutenberg') ?>
            </th>
            <td>
                <label>
                    <input type="text"
    ...
    <div class="advgb-form-buttons-bottom">
        ...
        >
            <?php
            esc_html_e('Save Form Settings', 'advanced-gutenberg') ?>
        </button>
    </div>
</form>
